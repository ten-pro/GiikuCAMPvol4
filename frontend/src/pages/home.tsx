...
{/* key={index} index={index} onRadioChange={handleRadioChange} */}
    ...
    <div style={{display: "flex"}}>
        <HomeGpt indexRadio={0} onRadioChange={handleRadioChange} indexSelect={0} onSelectChange={handleSelectChange} indexName={0} onInputChange={handleInputChange} gptState={gptStates[0]} setGptState={(newState) => setGptState(0, newState)} color="#ff0000" lCheck={false} pCheck={true} src="/HomeImage/gptLogo1.png" placeholder='Ada' position='1' loading='11' positive='111' negative='a' one='aa' all='aaa'/>
        <HomeGpt indexRadio={1} onRadioChange={handleRadioChange} indexSelect={1} onSelectChange={handleSelectChange} indexName={1} onInputChange={handleInputChange} gptState={gptStates[1]} setGptState={(newState) => setGptState(1, newState)} color="#CC00FF" lCheck={true} pCheck={false} src="/HomeImage/gptLogo2.png" placeholder='Babbage' position='2' loading='22' positive='222' negative='b' one='bb' all='bbb'/>
    </div>
    <div style={{display: "flex"}}>
        <div style={{display: "flex"}}>
            <HomeGpt indexRadio={2} onRadioChange={handleRadioChange} indexSelect={2} onSelectChange={handleSelectChange} indexName={2} onInputChange={handleInputChange} gptState={gptStates[2]} setGptState={(newState) => setGptState(2, newState)} color="#33E9E9" lCheck={false} pCheck={true} src="/HomeImage/gptLogo3.png" placeholder='Curie' position='3' loading='33' positive='333' negative='c' one='cc' all='ccc'/>
            <HomeGpt indexRadio={3} onRadioChange={handleRadioChange} indexSelect={3} onSelectChange={handleSelectChange} indexName={3} onInputChange={handleInputChange} gptState={gptStates[3]} setGptState={(newState) => setGptState(3, newState)} color="#FFD56A" lCheck={true} pCheck={false} src="/HomeImage/gptLogo4.png" placeholder='Davinci' position='4' loading='44' positive='444' negative='d' one='dd' all='ddd'/>
        </div>
